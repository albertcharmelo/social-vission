...
export function ClientTopbar() {
  ...
  return (
    <header className="sticky top-0 z-30 bg-cloud/90 backdrop-blur-md border-b border-sage/30">
      <div className="flex items-center justify-between h-16 px-4 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="w-8 h-8 rounded-full bg-sky/15 flex items-center justify-center text-deep text-xs font-semibold">
            JP
          </div>
        </div>
      </div>
